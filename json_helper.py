...
class JSONHelper:
    ...
    def get_experiment_data_folder() -> os.path:
        stas_main_dir = dirname(Path(os.path.abspath(__file__)))
        recording_dir = os.path.join(stas_main_dir, "stas-experiment-data")
    ...
    def get_file_path_folder(folder: str = "") -> os.path:
        ...
        parent_directory = dirname(os.path.abspath(__file__))
        # Move to experiments repository
        log_directory = os.path.join(parent_directory, "stas-experiment-data")
        if folder:
